        ...
        <section className="py-20 bg-transparent" id="blog">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="mt-12 grid gap-8 md:grid-cols-3">
                    {posts.map(post => (
                        <article key={post.id} className="bg-metallic-900/50 backdrop-blur-xl border border-white/5 rounded-2xl overflow-hidden shadow-xl hover:shadow-2xl hover:-translate-y-1 transition-all duration-300 group">
                            {post.hero_image && (
            ...
            {activePost && (
                <div className="fixed inset-0 bg-black/80 backdrop-blur-sm z-50 flex items-center justify-center p-4 animate-fadeIn">
                    <article className="bg-metallic-900 border border-white/10 rounded-2xl shadow-2xl max-w-3xl w-full max-h-[90vh] overflow-y-auto p-6 relative">
                        <button
