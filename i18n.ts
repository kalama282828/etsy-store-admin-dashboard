...
export const translations = {
  tr: {
    ...
    dashboard_menu_dashboard: 'Genel Bakış',
    dashboard_menu_booster: 'Dönüşüm Araçları',
    dashboard_menu_content: 'Ana Sayfa Metinleri',
    dashboard_menu_packages: 'Planlar & Fiyatlar',
    dashboard_menu_stripe: 'Ödeme / Stripe',
    dashboard_menu_blog: 'Blog & Yapay Zeka',
    dashboard_menu_messages: 'Mesajlar',
    dashboard_loading: 'Veriler yükleniyor...',
    dashboard_error_title: 'Veri Alınırken Hata Oluştu',
    dashboard_content_title: 'Ana Sayfa İçerik Yönetimi',
    dashboard_packages_title: 'Fiyatlandırma Paketleri',
  ...
  en: {
    ...
    dashboard_menu_dashboard: 'Overview',
    dashboard_menu_booster: 'Conversion Tools',
    dashboard_menu_content: 'Homepage Copy',
    dashboard_menu_packages: 'Plans & Pricing',
    dashboard_menu_stripe: 'Payments / Stripe',
    ...
    dashboard_content_title: 'Homepage Content Management',
    dashboard_packages_title: 'Pricing Packages',
